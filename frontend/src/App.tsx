  ...
  const [settings, setSettings] = usePersistedState<Settings>(
    {
      ...
      videoModel: null,
      promptTheme: "Cinematic realistic",
    ...
    >
      ...
      >
        {isSettingsOpen ? (
          ...
          <>
            {appState === AppState.INITIAL && !scriptStudioOpen && (
              <StartPane
                doCreate={doCreate}
                ...
                onOpenScriptStudio={() => setScriptStudioOpen(true)}
              />
            )}
            ...
            {appState === AppState.INITIAL && scriptStudioOpen && (
              <ScriptStudio
                settings={settings}
                setSettings={setSettings}
                onBack={() => setScriptStudioOpen(false)}
              />
            )}
